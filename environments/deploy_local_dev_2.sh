...
current=$(pwd)
echo $current
apisPath=$(grep -ioP "(apisPath\s*=\s*)\K.+" _installers_dev.properties)
uiPath=$(grep -ioP "(uiPath\s*=\s*)\K.+" _installers_dev.properties)

[[ "$apisPath" = "default"  ]] && apisPath="${current}/../services"
[[ "$uiPath" = "default" ]] && uiPath="${current}/../front"

# Minikube namespace
project=$(grep -ioP "(project\s*=\s*)\K.+" _installers_dev.properties)

# Databases
postgreSQL=$(grep -ioP "(postgreSQL\s*=\s*)\K.+" _installers_dev.properties)
influxDB=$(grep -ioP "(influxDB\s*=\s*)\K.+" _installers_dev.properties)
# APIs
hdr=$(grep -ioP "(hdr\s*=\s*)\K.+" _installers_dev.properties)
kpi=$(grep -ioP "(kpi\s*=\s*)\K.+" _installers_dev.properties)
influx=$(grep -ioP "(influx\s*=\s*)\K.+" _installers_dev.properties)
ingestion=$(grep -ioP "(ingestion\s*=\s*)\K.+" _installers_dev.properties)
user=$(grep -ioP "(user\s*=\s*)\K.+" _installers_dev.properties)
baseApi=$(grep -ioP "(base\s*=\s*)\K.+" _installers_dev.properties)
wrapperApi=$(grep -ioP "(wrapper\s*=\s*)\K.+" _installers_dev.properties)
dataApi=$(grep -ioP "(data\s*=\s*)\K.+" _installers_dev.properties)
kubeflowApi=$(grep -ioP "(kubeflow\s*=\s*)\K.+" _installers_dev.properties)
keycloakInitializer=$(grep -ioP "(keycloakInitializer\s*=\s*)\K.+" _installers_dev.properties)
# Others
ui=$(grep -ioP "(ui\s*=\s*)\K.+" _installers_dev.properties)
keycloak=$(grep -ioP "(keycloak\s*=\s*)\K.+" _installers_dev.properties)
grafana=$(grep -ioP "(grafana\s*=\s*)\K.+" _installers_dev.properties)
nifi=$(grep -ioP "(nifi\s*=\s*)\K.+" _installers_dev.properties)
wso2=$(grep -ioP "(wso2\s*=\s*)\K.+" _installers_dev.properties)
