...
public class RenewabilityController {
	...
	@PostMapping()
	public ResponseEntity<?> addMeasurement(@RequestBody Renewability renewability, @RequestParam Map<String, String> tags){
    	System.out.println(renewability);
		repository.insert(renewability, tags);
