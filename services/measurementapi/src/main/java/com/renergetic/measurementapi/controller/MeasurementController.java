...
// GET REQUESTS
    ...
    public ResponseEntity<List<MeasurementDAOResponse>> getData(
            ...
            @RequestParam(name = "cumulative") Optional<Boolean> cumulative,
        ...
        ret = service.data(bucket.orElse("renergetic"), measurements, fields, parsedTags, from.orElse(""), to.orElse(""),
                "time", cumulative.orElse(true),performDecumulation.orElse(false), getTags.orElse(true), onlyLastestPrediction.orElse(false));
