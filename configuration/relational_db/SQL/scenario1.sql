...
/* PRODUCTION SCREEN */
( 1, 'energy_share', 'Energy share', '{"x":5,"y":0,"w":2,"h":1}', '{"icon_visibility":false, "background": "none"}', 'single', 2 ),
( 2, 'electricity', 'Electricity', '{"x":0,"y":0,"w":5,"h":10}', '{"icon":"electricity", "background":"linear-gradient(to right, #343638, #4ea5c5a0, #343638)"}', 'doughnut', 2 ),
( 3, 'heat', 'Heat', '{"x":7,"y":0,"w":5,"h":10}', '{"icon":"heat", "background":"linear-gradient(to right, #343638, #8e6faaa0, #343638)"}', 'doughnut', 2 ),
( 4, 'renewables', 'Renewables', '{"x":5,"y":1,"w":2,"h":3}', '{"icon":"renewables", "background":"radial-gradient #7ece9b80, #343638)"}','single', 2 ),
( 5, 'non_renewables', 'Fosil Fuels', '{"x":5,"y":3,"w":2,"h":3}', '{"icon":"fossil_fuels", "background":"radial-gradient(#c9595980, #343638)"}', 'single', 2 ),
( 6, 'external', 'External', '{"x":5,"y":5,"w":2,"h":3}', '{"icon":"import", "background":"radial-gradient(#d4bc6b80, #343638)"}', 'single', 2 ),
/* CONSUMPTION SCREEN */
...
( 7, 90, NULL, NULL, NULL, NULL, NULL, NULL, 4 ),
( 8, 91, NULL, NULL, NULL, NULL, NULL, NULL, 5 ),
( 9, 92, NULL, NULL, NULL, NULL, NULL, NULL, 6 ),
