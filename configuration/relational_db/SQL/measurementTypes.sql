ALTER TABLE public.measurement_type
    ADD COLUMN physical_name character varying(50) NOT NULL ;
INSERT INTO measurement_type ( id, name,physical_name, label, base_unit, unit, factor, color ) 
    VALUES( 1, 'power_w', 'power','Power [W]', 'W', 'W', 1.0, '#4CAF50'),
     ( 2, 'energy','energy', 'Energy[Wh]', 'Wh', 'Wh', 1.0, '#AAAF50'), 
     ...
     ( 9, 'energy_mwh','energy', 'Power [MWh]', 'Wh', 'MWh', 1000000, '#4CAF50'),
